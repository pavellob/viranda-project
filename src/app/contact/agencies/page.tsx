...
export const metadata: Metadata = {
  title:
    'Сотрудничество с эвент-агенствами и организаторами мероприятий',
  ...
  return (
    <>
      <PageIntro
        ...
        title="Сотрудничество с эвент-агенствами и организаторами мероприятий"
      >
        <p>
          Viranda project сотрудничает эвент-агенствами в качестве подрядчика. Мы можем стать частью вашего события или провести праздник “Под Ключ”
          <Link
          target='blank'
