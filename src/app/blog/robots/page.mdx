...
export const article = {
  ...
  title: 'Robots - какие роботы лучшие',
  description:
    'Если ваш ребенок заинтересовался робототехникой, сегодня есть варианты помимо роботов из сигаретных пачек. Выбираем лучший',
  author: {
    name: 'Лобачев Павел',
